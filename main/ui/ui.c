...
///////////////////// VARIABLES ////////////////////
static lv_obj_t* ui_screen_list[6];
...
void ui_init( void )
{
    ...
    ui_screen_list[0] = ui_Screen2_screen_init();
    ui_screen_list[1] = ui_Screen1_screen_init();
    ui_screen_list[2] = ui_Screen10_screen_init();
    ui_screen_list[3] = ui_Screen11_screen_init();
    ui_screen_list[4] = ui_Screen12_screen_init();
    ui_screen_list[5] = ui_Screen13_screen_init();
...
{
    lv_obj_t* target = ui_screen_list[index + 1];
    return target;
}
