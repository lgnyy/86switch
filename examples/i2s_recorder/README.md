...
In this example, we record a sample audio file captured from the digital MEMS microphone on the I2S peripheral using STD data format.
...
* A digital microphone (INMP441 STD output was used in this example)

The digital STD microphone is connected on the I2S interface `I2S_NUM_0`.
...
```
I (361) std_rec_example: STD microphone recording Example start
...
I (431) std_rec_example: Initializing SD card
I (431) std_rec_example: Using SDMMC peripheral
I (441) gpio: GPIO[13]| InputEn: 0| OutputEn: 1| OpenDrain: 0| Pullup: 0| Pulldown: 0| Intr:0
Name: USD
Type: SDHC/SDXC
Speed: 20 MHz
Size: 3813MB
I (481) std_rec_example: Starting recording for 60 seconds!
I (481) std_rec_example: Opening file
I (60451) std_rec_example: Recording done!
I (60471) std_rec_example: File written on SDCard
I (60471) std_rec_example: Card unmounted
```
