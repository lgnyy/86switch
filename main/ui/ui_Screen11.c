...
lv_obj_t* ui_Screen11_screen_init(void)
{
    ...
    for (int i = 0; i < 3; i++) {
        ...
        lv_obj_t* ui_Image27 = lv_img_create(ui_Image28);
    ...
    lv_obj_add_event_cb(ui_Image26, ui_event_All_eud, LV_EVENT_CLICKED, (void*)1);
    lv_obj_add_event_cb(ui_Image32, ui_event_All_eud, LV_EVENT_CLICKED, (void*)0);
    return ui_Screen11;
}
